...
const InformationRequest = () => {
    ...
    const [type, setType] = useState("Information Request");

    const hundelInformationRequest = () => {
        try {
            ...
            <div className="contentcontact">
                <div className="container">
                    < div className="row justify-content-center" >
                        < div >
                            <h3 className="heading mb-4">Information Request</h3>
                            <h5>
                            ...
                            <Button type="primary"
                                ...
                                onClick={() => hundelInformationRequest()}
                                size="large"
